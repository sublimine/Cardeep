...
**Trabajo diferido a F5/F6, declarado, no ejecutado todavía**: frontend del foro (feed/hilo/composer/perfil/heatmap), endurecimiento final F6 (SLA de moderación medido y publicado, KPI §4.10 confirmado en producción, auditoría cruzada de cada número en pantalla contra §4 uno a uno).
