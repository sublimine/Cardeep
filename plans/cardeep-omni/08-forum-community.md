...
**Trabajo diferido a F4/F5, declarado, no ejecutado en este bloque**: el foro completo (`forum_thread`/`forum_post`/`post_anchor`/`post_vote`/`reputation_event`/`moderation_flag`, ranking §4.1, feed/hilo/perfil/heatmap). Endurecimiento final F6 (SLA de moderación, auditoría cruzada de cada número en pantalla) también pendiente.
