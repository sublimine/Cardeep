...
**7 bloques cerrados + verificados + commiteados** (todos €0, sin DB, causa-raíz, TDD): T4.1 (ladder blindado), T0.1/0.2/0.3 (bomba RIVR neutralizada + guardrail clase + higiene), T1.3 (property invariants, mutación-probada), T4.3 (VAM offline cero), T2.3 (Chao).
**RESTA, por gate:**
