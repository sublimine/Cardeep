...
⇒ **TODA vía de alta palanca sin-owner/sin-red AGOTADA con calidad** y verificada contra PG donde aplica (3 invariantes mecánicos + re-cluster + 100 goldens). Lo restante requiere genuinamente decisión-owner (prod cutover) o recursos externos (red/datos reales). Docker + `:5434` (HEAD 0071, fixture) vivos. **25 commits sobre d9f6269.**
