...
export default {
  content: [
    './index.html',
    './src/**/*.{ts,tsx}',
    // The landing ships its own Tailwind v4 stylesheet, scoped under `.cx-v4`
    // (tools/build-landing-css.mjs). Scanning it here too would emit a second,
    // unscoped v3 definition of the same class names — dead weight at best, and
    // v3 values for utilities the landing expects to be v4 ones.
    '!./src/landing-v4/**',
  ],
  darkMode: 'class',
