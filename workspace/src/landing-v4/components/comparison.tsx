...
import { BRAND, COMPARISON } from '@landing/content/site';
 ...
 * naked type parameter keeps the tuple length, so adding or dropping a row
 * without its icon fails to compile instead of rendering an empty cell.
 */
