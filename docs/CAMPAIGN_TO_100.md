...
| **B4** | Geo al átomo | gap municipio RECUPERABLE→<2%; cada entidad a municipio/comarca; residual de-fuente confesado | **en curso** (gap real 21,66%; B4.1 probe✓ `462e03c` NO_CITY=0 · B4.2✓ `96b823b` resolver fuzzy+núcleos-INE+ambiguity-guard, 41 tests · B4.3 reverse-geocode+CP en curso · pend B4.4 upsert re-resuelve NULL + B4.5 re-geocode backlog+medición; diseño `docs/design/B4_GEO_DESIGN.md`) |
