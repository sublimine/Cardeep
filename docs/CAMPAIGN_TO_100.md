...
| **B5** | Cobertura total + filtrado | sells_cars resuelto; particular vs dealer decidido; Canarias/Ceuta/Melilla cerrados; cada segmento sellado o gap-con-causa | **en curso** (recon✓: denominadores FACONAUTO 2.143g/5.358i, desguace censo DGT 1.292, CNAE 4511 ~27k; split 328.776 particular/50.167 POS [VERIFICADO]; wallapop cap=config-no-API con fix memoria presente. B5.1 wallapop exhaustivo `--target 100k` lanzado (cierra geo wallapop+cobertura); diseño `docs/design/B5_COVERAGE_DESIGN.md`; pend B5.2 filtrado professional · B5.3 deflación · B5.4 Chapman · B5.5 long-tail AS24/Overture · B5.6 Ceuta/Melilla) |
