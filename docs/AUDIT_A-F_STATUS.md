...
| A3 | Scrapear TODO (exhaustividad B9) | 🟡 GATED (AS24+coches.net ✅ 100%) | HARVEST | B9 gate €0 existe. **2 mayores fuentes ES DRENADAS 100% (2026-06-21):** (1) **AS24** via as24_facet, rango total precios 0-∞: bruto 309.212 / cota neta SQL ≥251.425 (cluster 37.149 + photo único 214.276) / 2.786 dealers; fix-raíz expand_bands (bandas anchas truncaban a 4k/200-pag cap → subdivide <cap); residual ~1.7-2k precio-pico (0.6%). (2) **coches.net** via coches_net_facet, 52/52 provincias: +66.450 coches NUEVOS-ABSOLUTOS (descontado overlap AS24) / bruto 334.595 / 8.199 dealers; fix-raíz private_caged (KeyError crasheaba todo run). Dedup full exacto STAGED (RAM 2.9<4GB). Resto fuentes = paced harvest |
