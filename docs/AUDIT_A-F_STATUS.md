...
| A3 | Scrapear TODO (exhaustividad B9) | 🟡 GATED (4 marketplaces mayores ✅) | HARVEST | B9 gate €0 existe. **4 fuentes mayores ES drenadas (2026-06-21):** (1) **AS24** as24_facet precios 0-∞: bruto 309.212 / neta SQL ≥251.425 / 2.786 dealers; fix expand_bands. (2) **coches.net** coches_net_facet 52/52 prov: +66.450 nuevos-absolutos / bruto 334.595 / 8.199 dealers; fix private_caged. (3) **wallapop PRO** wallapop_facet seller_type=professional 18/18 celdas: +96.333 nuevos-absolutos DEALERS; VAM UNVERIFIED por deuda integridad histórica (3.1%, a investigar; drain limpio, cobertura DB-delta-verificada). (4) **milanuncios** milanuncios_wholesale 52/52 prov (facet province+price): +39.217 nuevos-absolutos sesión / DB compraventa 295.017 + particular 141.339 + concesionario_oficial 913 / 15.445 dealers; VAM TRUSTWORTHY. + vo_chains +2.487 + OEM ~15 +2.354 + group_subastas +3.875. autocasion=bajo-ROI. **DEDUP GLOBAL EJECUTADO (2026-06-21, RAM 5.5GB):** 2.155.401 listings -> **1.833.647 coches físicos únicos (NETA EXACTA)** / 321.754 duplicados colapsados; anti-FP CHECK1 FAIL 2.382 cross-province merges (≤0.13%, a investigar Signal-A-legítimo vs FP). Exclusivos/fuente: wallapop 565.763 / coches.net 277.886 / milanuncios 208.586 / AS24 196.634. **Cobertura €0 de fuentes conocidas ~agotada.** Pendiente €0: motorflash (bug), family por-dealer (discovery nuevos dominios), R1 desguace, oem faltantes. |
