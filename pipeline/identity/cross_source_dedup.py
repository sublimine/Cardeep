...
# Country-proof second belt — shared with cluster_dealers. Re-exported so existing importers
# (tests, callers) keep importing CrossCountryClusterError from this module.
from pipeline.identity._country_guard import (  # noqa: E402
    CrossCountryClusterError,
    assert_single_country_clusters,
)
